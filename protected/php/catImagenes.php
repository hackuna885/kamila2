...
if (empty($_GET['pag'])) {
	...
	$cs = $con -> query("SELECT COUNT(nomObj_catProd) AS noRegs FROM catProd WHERE catEst_catProd = '1'");
	...
	while ($resul2 = $cs2 -> fetchArray()) {
		...
		echo'<div class="col-12 col-sm-4">
				...
				<button type="button" class="btn btn-outline-secondary mx-auto d-block mb-5">Más detalles</button>
			</div>
		';
	}
